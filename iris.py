...
import pandas as pd
import numpy as np
import matplotlib.pyploy as plt # type: ignore
...
inpur_df = user_input_features()
# print(input_df)

# 사용자 입력 값 표시
st.subheader("User Input Parameters")
st.write(input_df) # type: ignore
...
# 예측
prediction = model.predict(input_df.to_numpy()) # type: ignore
print(prediction, iris.target_names)

prediction_prob = model.predict_proba(inpur_df.to_numpy())
